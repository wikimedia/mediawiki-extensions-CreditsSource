<?php
/**
 * Internationalisation file for CreditsSource extension.
 *
 * @package MediaWiki
...
$messages['dsb'] = array(
	...
	'creditssource-source-work' => 'Toś ten bok jo wót boka $1 na $2 w jogo wersiji wót $6 $7 (UTC) wótwóźony. Tam jo se pód licencu CC BY-SA 3.0 wózjawił. Dalšn drobnostki a dopołna lisćina awtorow su na pśisłušnem boku $5. Awtory projekta Wikitravel markěruju se pśez prefiks $4.',
...
$messages['es'] = array(
	...
	'creditssource-credits' => 'Esta página se deriva de la página [$1 $2] en [$3 $4] en su revisión de $8 a las $9 (UTC).
Ahí, se publicó bajo la licencia CC-BY-SA 3.0. Para ver más detalles y la lista completa de colaboradores puedes encontrarlo en el [[$5|historial de la página]].
Los colaboradores de Wikitravel están marcados con el prefijo $6.',
 ...
 */
$messages['ko'] = array(
	'creditssource-desc' => '문서 바닥글에 원본 작업 제작진을 보여줍니다',
	'creditssource-source-work' => '이 문서는 $6 $7 (UTC)에 $1 문서의 $2 판에서 파생됩니다. 그래서 CC BY-SA 3.0 라이선스에 따라 게시합니다. 더 자세한 정보와 기여자의 전체 목록은 관련된 $5에서 찾을 수 있습니다. Wikitravel 기여자는 $4 접두어로 보입니다.',
 ...
 */
$messages['ksh'] = array(
	'creditssource-desc' => 'Deiht Aanjaabe övver de Quälle en Sigge aanzeije.',
	...
	'creditssource-creditpage' => 'Aanjaabe övver de Quälle',
);
...
$messages['ms'] = array(
	...
	'creditssource-source-work' => 'Halaman ini diterbitkan dari halaman $1 di $2 dalam semakan pada $6, $7 (UTC). Di situ, ia diterbitkan di bawah lesen CC BY-SA 3.0. Keterangan lanjut serta senarai penuh penyumbang boleh didapati di $5 yang berkenaan. Penyumbang Wikitravel bertandakan awalan $4.',
...
$messages['roa-tara'] = array(
	...
	'creditssource-source-work' => "Sta vôsce jè derivate da 'a vôsce $1 sus a $2 jndr'à revisiona soje da 'u $6 a le $7 (UTC). Addà, ste pubblecate sotte 'a licenze CC-BY-SA 3.0. Pe cchiù 'mbormaziune e l'elenghe comblete de le condrebbutore ponne essere cercate sus a pàgene assocaite $5. Le condrebbutore de Uicchitravel so marcate cu 'u prefisse $4.",
 ...
 */
$messages['sv'] = array(
	'creditssource-desc' => 'Visa erkännande för källverk i sidfoten',
	'creditssource-creditpage' => 'Ger erkännande för källverk.',
);
